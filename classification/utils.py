...
def texts_to_vectors(texts_paths):
    """
    Calculate matrix of features for texts_paths (array of paths)
...
def divide_texts(paths, ratings_vector, categories_vector, ids_vector, n=15):
    """
    ...
    return features, new_ratings_vector, new_categories_vector, new_ids_vector, new_paths_vector
