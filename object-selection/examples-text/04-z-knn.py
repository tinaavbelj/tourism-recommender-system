...
scores_rmse = []
for i in range(10):
    cv_results_file = '../results/cv-generated-data-r-10-n-04-z-knn-' + str(i) + '.csv'
...
results_file = '../scores/generated-data-r-10-n-04-z-knn-auc.csv'
save_scores(scores_auc, results_file)
results_file = '../scores/generated-data-r-10-n-04-z-knn-rmse.csv'
